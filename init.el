...
(use-package evil                 :init   (setq evil-want-keybinding nil)
				          ...
				          (define-key evil-motion-state-map "," nil)
                                          (define-key evil-motion-state-map "SPC" hydra-global/body)
...
(use-package major-mode-hydra
  ...
  (major-mode-hydra-define hydra-org-mode (:exit t)
  ...
  (pretty-hydra-define hydra-cerberus (:exit t)
    ("Buffers" (("b" consult-buffer)
     ...
     "Describe" (("h" helpful-symbol)
		 ...
		 ("m" describe-mode)
		 ("p" helpful-at-point))
     "Manuals" (("d" define-word)
		("D" define-word-at-point)
		("i" (info (completing-read "Info entry: " (info--manual-names nil))))
		("M" man))
  ...
  (pretty-hydra-define hydra-global (:exit t)
    ("Local"
     ...
     "Launch"
     (("d" dired-jump)
      ("z" dashboard-refresh-buffer)
      ("n" elfeed)
      ("E" vterm)
      ("s" (launch "flameshot gui"))
      ("b" (launch "brave"))
      ("R" launch)
      ("l" (launch "slock")))
     "Other"
     (("SPC" major-mode-hydra "Major")
      ("v" eval-last-sexp)
      ("h" hydra-cerberus/body "Buffer/Window/Help")
