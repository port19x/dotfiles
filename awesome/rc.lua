...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume",       function () awful.spawn("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+") end, {description = "raise volume", group = "mediakey"}),
    awful.key({}, "XF86AudioLowerVolume",       function () awful.spawn("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-") end, {description = "lower volume", group = "mediakey"}),
    awful.key({}, "XF86AudioMute",              function () awful.spawn("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle") end, {description = "toggle (mic) mute", group = "mediakey"}),
    awful.key({}, "Print",              function () awful.spawn("flameshot gui") end, {description = "take a screenshot", group = "mediakey"}),
...
-- Autostart
awful.spawn.with_shell('xrandr --output DP-1-1 --left-of eDP-1 --rotate right --output DP-1-2 --left-of DP-1-1 --rotate left')
